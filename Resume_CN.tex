...
\begin{center}
  ...
  \small 
  \faPhone* \hspace{2pt} \texttt{15958040713} \hspace{8pt} $|$ \hspace{8pt}
  ...
  \\ \vspace{4pt}
  \faGithub \hspace{2pt} \href{https://github.com/lokinko}{\texttt{GitHub | lokinko}} \hspace{8pt} $|$ \hspace{8pt}
...
\section{项目经验}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \small 项目背景：构建系统级通用的自动执行能力，深入探索GUI Agent基模及框架能力，为用户解决「简单到不想做, 复杂到不会做」的日常需求，打造主动、个性化的 OS 级执行助手。
        \resumeItemListStart
